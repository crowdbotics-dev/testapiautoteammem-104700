...
## Project Structure
    ...
    ├── testapiautoteammem_104700  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammem_104700`
...
2. Clone this repo and `cd testapiautoteammem_104700`
